...
const state = {
  ...
  rulesConfig: {
    '需求完整性检查': true, '语义冲突检测': true, '可追溯性检查': true,
    '粒度合理性检查': true, '依赖无环检测': true,
    '架构合规检查': true, '技术选型评估': true,
    '编码规范检查': true, '安全漏洞扫描': true, '代码复杂度检查': true,
    '最佳实践检测': true, '覆盖率门禁': true, '测试通过率': true,
