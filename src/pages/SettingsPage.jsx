    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 text-sm mt-1">配置和管理智能软件工厂的各项设置</p>
        </div>
      </div>
                ...
                <div>
                  ...
                  <div className="space-y-4">
                    <div className="grid grid-cols-2 gap-6">
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">工厂名称</label>
                        <input
                          type="text"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-700 mb-2">工厂编号</label>
                        <input
                          type="text"
                    ...
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div>
                        ...
                        <p className="text-sm text-gray-500">自动刷新看板和监控数据</p>
                      </div>
                      ...
                      {users.map(user => (
                        <tr key={user.id} className="hover:bg-gray-50 transition-colors">
                          ...
                          <td className="px-4 py-3 text-right">
                            <button className="text-indigo-600 hover:underline text-sm">编辑</button>
                          </td>
                        </tr>
                      ))}
                    </tbody>
                    ...
                    <div key={notification.id} className="flex items-center justify-between p-4 border border-gray-200 rounded-xl hover:bg-gray-50 transition-colors">
                      ...
                      <div className="flex items-center gap-2">
                        {notification.channels.map((channel, index) => (
                          <span key={index} className="px-2 py-1 bg-gray-100 text-gray-600 text-xs rounded">{channel}</span>
                        ))}
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">启用双因素认证提高账户安全性</p>
                        </div>
                      </div>
                    ...
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-3">
                        ...
                        <div>
                          ...
                          <p className="text-sm text-gray-500">查看账户的登录历史记录</p>
                        </div>
                      </div>
                      <button className="px-4 py-2 bg-white border border-gray-300 rounded-lg text-sm text-gray-700 hover:bg-gray-50 transition-colors">
                        查看日志
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-4">
                      <button className="px-6 py-3 bg-indigo-600 text-white rounded-lg font-medium">浅色</button>
                      <button className="px-6 py-3 bg-gray-100 text-gray-600 rounded-lg font-medium hover:bg-gray-200 transition-colors">深色</button>
                      <button className="px-6 py-3 bg-gray-100 text-gray-600 rounded-lg font-medium hover:bg-gray-200 transition-colors">自动</button>
                    </div>
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-3">紧凑模式</label>
                    <div className="flex items-center justify-between p-4 bg-gray-50 rounded-lg">
                      <div>
                        <p className="font-medium text-gray-700">开启紧凑模式</p>
                        <p className="text-sm text-gray-500">减少界面元素的间距，在屏幕上显示更多内容</p>
                      </div>
