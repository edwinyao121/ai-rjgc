...
| 前置条件 | 生成与交付策略已确认。 |
| 基本流程 | 1. 云端总控智能体结合需求和项目规范生成执行计划。<br>2. 计划列出影响模块、生成文件、测试策略、构建方式和部署影响。<br>3. 开发人员确认技术可行性和本地执行条件。<br>4. 项目负责人确认范围和阶段目标。<br>5. 系统锁定计划版本并启动执行。 |
...
| 基本流程 | 1. 本地智能体获取任务和项目规范。<br>2. 从代码仓库获取指定代码版本。<br>3. 读取工程结构、依赖配置、接口、数据模型和测试现状。<br>4. 检查本地工具、运行环境和权限。<br>5. 形成上下文摘要并上报云端总控智能体。 |
...
| 项目 | 内容 |
| --- | --- |
| 用例目标 | 按执行计划和项目规范生成或修改应用代码、接口、数据结构及配置。 |
| 主要参与者 | 本地智能体、开发人员 |
| 前置条件 | 本地上下文和执行环境检查通过。 |
