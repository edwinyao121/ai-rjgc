...
| 参与者 | 职责定位 | 主要操作 |
| --- | --- | --- |
| 项目负责人 | 对测试目标、范围、验收标准、风险处置和阶段结论负责 | 发起任务、确认目标与标准、决定升级事项、确认放行或终止 |
| 开发人员 | 对测试技术可执行性、失败归因、修复方案和本地技术结论负责 | 提供技术上下文、审查测试方案、确认归因、审查并实施修复 |
| 云端总控智能体 | 对云端信息汇总、证据分析、建议和审查辅助负责，不替代人员作最终决策 | 形成任务包、汇总证据、提出管理建议、辅助结果审查、沉淀知识候选 |
| 本地智能体 | 在本地受控环境中完成测试设计、执行、失败分析、修复和回归 | 获取上下文、生成测试、执行测试、分析失败、生成补丁、执行回归 |
| 质量人员 | 对测试覆盖、断言合理性、回归充分性和质量风险负责 | 审查测试计划、审查回归结果、提出质量意见、确认剩余风险 |
| 外部系统 | 提供代码、依赖、构建、制品、测试环境和日志能力 | 提供 Git 代码、流水线、制品仓库、测试环境和执行日志 |

### 2.1 责任边界

```text
项目负责人：决定测什么、测到什么程度、是否调整范围以及阶段结论。
开发人员：负责测试技术处理、失败归因、修复方案和本地技术确认。
云端总控智能体：负责汇总、分析、建议、审查辅助和记录，不独立决策。
本地智能体：负责在本地实际获取、执行、修复和回归，不改变任务目标和验收标准。
质量人员：独立审查测试覆盖、断言、回归结果和剩余质量风险。
外部系统：提供代码、构建、制品、环境和日志等事实，不负责业务决策。
```
